...
bool Backend::PerformPureVisualBundleAdjustment() {
    ...
    // Report information.
    ReportInfo("[Backend] Pure visual BA adds " << all_frames_p_wc.size() << " frames_p_wc, " << all_frames_q_wc.size() << " frames_q_wc, "
                                                << all_features_invdep.size() << " features_invdep, " << all_visual_factors.size()
                                                << " visual_reproj_factors.");
