#ifndef _VIO_STEREO_SCHUR_VINS_DATA_LOADER_LOG_H_
#define _VIO_STEREO_SCHUR_VINS_DATA_LOADER_LOG_H_
...
#endif // end of _VIO_STEREO_SCHUR_VINS_DATA_LOADER_LOG_H_
